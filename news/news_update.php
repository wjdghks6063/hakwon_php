<?	include "common/common_header.php";
    ...
    $query="select a.title, a.content, a.attach, b.name,a.reg_id, a.reg_date from h_news a, h_member b where a.reg_id = b.id and a.no='$no'";
					...
					<fieldset>
						...
						<style>
							...
							<tr>
                                ...
                                <p class="img"><img src="/file_room/news/<?=$row["attach"]?>"></img></p>
                                <?=$row["attach"]?> 
							...
							<tr>
								...
								<input type="button" onclick="location.href='news_list.php'" value="목록" class="btn">
								</td>
							</tr>
	...
	<?include "common/common_footer.php"?>
		...
		if(file.value !=""){
			...
			if(fileSize > maxSize){
                ...
                news.method="post";
                news.action="db_news_update.php";
                news.submit();
            }
		</script>
